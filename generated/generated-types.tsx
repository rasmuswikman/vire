...
export type MutationDeleteTodoArgs = {
  input?: InputMaybe<Array<TodoInput>>;
};
...
export type PlaceOrderInput = {
  cart_id: Scalars['String'];
  payment_provider_id?: InputMaybe<Scalars['String']>;
};

export type PlaceOrderOutput = {
  __typename?: 'PlaceOrderOutput';
  order: Order;
  payment_provider_parameters?: Maybe<Scalars['String']>;
  payment_provider_url?: Maybe<Scalars['String']>;
};
...
export type PriceRangeFragment = {
  ...
  minimum_price: {
    __typename?: 'ProductPrice';
    discount?:
      | { __typename?: 'ProductDiscount'; amount_off?: number | null | undefined }
      | null
      | undefined;
    regular_price: {
      __typename?: 'Money';
...
export type ProductBundleFragment = {
  __typename?: 'BundleProduct';
  uid: string;
  ...
  name?: string | null | undefined;
  id: string;
  description?: { __typename?: 'ComplexTextValue'; html: string } | null | undefined;
  thumbnail?:
    | {
        __typename?: 'ProductImage';
...
export type ProductConfigurableFragment = {
  __typename?: 'ConfigurableProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
export type ProductGroupedFragment = {
  __typename?: 'GroupedProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_BundleProduct_Fragment = {
  __typename?: 'BundleProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_ConfigurableProduct_Fragment = {
  __typename?: 'ConfigurableProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_DownloadableProduct_Fragment = {
  __typename?: 'DownloadableProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_GroupedProduct_Fragment = {
  __typename?: 'GroupedProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_SimpleProduct_Fragment = {
  __typename?: 'SimpleProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
type ProductItems_VirtualProduct_Fragment = {
  __typename?: 'VirtualProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
export type ProductItemsFragment =
  | ProductItems_BundleProduct_Fragment
  | ProductItems_ConfigurableProduct_Fragment
  | ProductItems_DownloadableProduct_Fragment
  | ProductItems_GroupedProduct_Fragment
  | ProductItems_SimpleProduct_Fragment
  | ProductItems_VirtualProduct_Fragment;

export type ProductSimpleFragment = {
  __typename?: 'SimpleProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
...
export type ProductVirtualFragment = {
  __typename?: 'VirtualProduct';
  uid: string;
  sku?: string | null | undefined;
  url_key?: string | null | undefined;
  ...
  cart?:
    | {
        ...
        selected_payment_method?:
          | { __typename?: 'SelectedPaymentMethod'; code: string; title: string }
          | null
          | undefined;
      }
    | null
...
export type SetBillingAddressOnCartMutation = {
  ...
  setGuestEmailOnCart?:
    | {
        __typename?: 'SetGuestEmailOnCartOutput';
        cart: { __typename?: 'Cart'; email?: string | null | undefined };
      }
    | null
    | undefined;
  ...
  setPaymentMethodOnCart?:
    | {
        ...
        cart: {
          __typename?: 'Cart';
          selected_payment_method?:
            | { __typename?: 'SelectedPaymentMethod'; code: string }
            | null
            | undefined;
          payment_providers?:
            | Array<
  ...
  placeOrder?:
    | {
        __typename?: 'PlaceOrderOutput';
        payment_provider_url?: string | null | undefined;
        payment_provider_parameters?: string | null | undefined;
        order: { __typename?: 'Order'; order_number: string };
      }
    | null
    | undefined;
};
...
`;
export const ProductBundleFragmentDoc = gql`
  fragment productBundle on BundleProduct {
    id: uid
    uid
    sku
    url_key
...
`;
export const ProductConfigurableFragmentDoc = gql`
  ...
  ${PriceRangeFragmentDoc}
`;
export const ProductDownloadableFragmentDoc = gql`
  ...
  ${PriceRangeFragmentDoc}
`;
export const ProductGroupedFragmentDoc = gql`
  fragment productGrouped on GroupedProduct {
    id: uid
    uid
    sku
    url_key
  ...
  ${PriceRangeFragmentDoc}
`;
export const ProductItemsFragmentDoc = gql`
  fragment productItems on ProductInterface {
    id: uid
    uid
    sku
    url_key
...
export const ProductSimpleFragmentDoc = gql`
  fragment productSimple on SimpleProduct {
    id: uid
    uid
    sku
    url_key
  ...
  ${PriceRangeFragmentDoc}
`;
export const ProductVirtualFragmentDoc = gql`
...
export function useAddProductsToCartMutation(
  ...
  return Apollo.useMutation<
    AddProductsToCartMutation,
    AddProductsToCartMutationVariables
  >(AddProductsToCartDocument, options);
}
...
export type AddProductsToCartMutationOptions = Apollo.BaseMutationOptions<
  AddProductsToCartMutation,
  AddProductsToCartMutationVariables
>;
...
`;
export type SetBillingAddressOnCartMutationFn = Apollo.MutationFunction<
 ...
 *      method_code: // value for 'method_code'
 *      payment_method_code: // value for 'payment_method_code'
 *   },
 * });
 */
export function useSetBillingAddressOnCartMutation(
  baseOptions?: Apollo.MutationHookOptions<
    SetBillingAddressOnCartMutation,
    SetBillingAddressOnCartMutationVariables
  >,
  ...
  return Apollo.useMutation<
    SetBillingAddressOnCartMutation,
    SetBillingAddressOnCartMutationVariables
  >(SetBillingAddressOnCartDocument, options);
}
export type SetBillingAddressOnCartMutationHookResult = ReturnType<
  typeof useSetBillingAddressOnCartMutation
>;
export type SetBillingAddressOnCartMutationResult =
  Apollo.MutationResult<SetBillingAddressOnCartMutation>;
export type SetBillingAddressOnCartMutationOptions = Apollo.BaseMutationOptions<
  SetBillingAddressOnCartMutation,
  SetBillingAddressOnCartMutationVariables
>;
